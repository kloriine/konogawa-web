    ...
    <main>
        <div class="container">
            <div class="row mb-5">
                ...
                <p class="lead fw-normal">Should you have any question or concern, you can reach us by filling out the contact form, coming to our cafe, finding us on other social networks, or you can personally email us at: 
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-primary" id="notificationModalLabel">Notification</h5>
