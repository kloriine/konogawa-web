            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ms-4">
                            <a class="nav-link active fs-5" style="color: var(--bs-blue)" aria-current="page">About</a>
                        </li>
                        <li class="nav-item ms-4">
        ...
        <div class="container marketing">
            <div class="row featurette mt-5">
                ...
                <div class="col-lg-7 order-lg-1 mt-5">
                    ...
                    <p class="lead">Etiam sit amet dignissim ipsum, vitae pulvinar dolor. Vestibulum ut risus viverra, aliquam lacus sit amet, aliquet ligula. Vestibulum fringilla vestibulum dapibus. Vivamus pharetra eros venenatis massa fermentum venenatis. Morbi sit amet luctus lorem. Nunc vel lectus sed dui efficitur placerat.</p>
                </div>
            </div>
        </div>
